    ...
    return(
        <div className="flex flex-1 items-center justify-center">
            <div className="bg-[#182840]/90 blur-x w-3/4 h-3/4 rounded-2xl flex flex-col p-5 gap-4">
                <div>
                    <Link to={"/"}><img src={Return} className='w-5'></img></Link>
                </div>
                <div className='p-5 flex flex-col gap-5'>
                    <div className='flex flex-col gap-5'>
                        <h1 className="text-white text-5xl">{trip.name ?? "No Location"}</h1>
                        <h2 className="text-white text-3xl">{trip.location.name ?? "No Location"}</h2>
